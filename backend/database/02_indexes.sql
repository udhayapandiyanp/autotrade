...
CREATE INDEX idx_vehicles_price_year ON vehicles(price, year);
...
CREATE INDEX idx_vehicle_requests_buyer ON vehicle_requests(buyer_id);
CREATE INDEX idx_vehicle_requests_vehicle ON vehicle_requests(vehicle_id);
